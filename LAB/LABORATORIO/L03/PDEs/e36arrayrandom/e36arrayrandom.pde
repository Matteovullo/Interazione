//ricapitolo.
//ARRAY serve a conservare dati della stessa natura. se dobbiamo disegn 100 cerchi identici si 
//mettono dati essenziali (es posiz) e poi si usa il ciclo for
...
void setup(){
  ...
  for (int i=0; i<y.length; i++){ //i++=increm di 1
     //se array è new int [5]; fa una var array di 5 caselle e lo riempie col valore neutro 
     //di int (abbiamo chiamato int, non float o boolean)
